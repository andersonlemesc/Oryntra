            ...
            @else
                @if (! $this->twoFactorConfirmed())
                    ...
                    <div class="mt-4 flex flex-wrap gap-2">
                        <x-filament::button color="gray" size="sm" wire:click="enableTwoFactor" icon="heroicon-o-arrow-path">
                            Gerar novo QR
                        </x-filament::button>
                        <x-filament::button color="danger" size="sm" wire:click="cancelTwoFactorSetup">
                            Cancelar
                        </x-filament::button>
                    </div>
                @else
